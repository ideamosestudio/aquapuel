...
export default function AboutPage() {
  return (
    <main>
        ...
        <div className="container split-grid">
          ...
          <div className="story-copy">
            <span className="eyebrow">
              <span /> Nuestra manera de hacer
            </span>
            <h2>Calidad que se siente en cada vaso.</h2>
            <p>
              Trabajamos para que recibir agua sea algo fácil, claro y
              previsible. Desde el cuidado del producto hasta la coordinación de
              cada entrega, ponemos atención en los detalles que construyen
              confianza.
            </p>
            <p>
        ...
        <div className="container">
          ...
          <div className="value-grid">
            <article>
              ...
              <h3>Pureza</h3>
              <p>
                Tratamiento con ozono y una propuesta baja en sodio para el
                consumo cotidiano.
              </p>
            </article>
            <article>
              ...
              <h3>Confianza</h3>
              <p>
                Cuidamos la calidad del producto y cada punto de contacto con
                nuestros clientes.
              </p>
            </article>
            <article>
              ...
              <h3>Cercanía</h3>
              <p>
                Una atención simple y humana, tanto para hogares como para
                equipos de trabajo.
              </p>
            </article>
            <article>
              ...
              <h3>Conciencia</h3>
              <p>
                Bidones retornables que acompañan una forma más responsable de
                consumir.
              </p>
            </article>
          </div>
      ...
      <ClosingCta
        title="Que nunca falte lo esencial."
        text="Contanos dónde necesitás Aquapuel y coordinemos una propuesta para vos."
      />
      <SiteFooter />
    </main>
  );
